 ...
 *
 * La tanda estrecha la puerta del reenganche al pelotón (`rejoinGapSeconds`, 22 s → 5 s) porque el
 * que entraba adoptaba el reloj del grupo y se comía el hueco de golpe: medido sobre un Giro entero
 * buscando kilómetros hechos a más de 120 km/h, **todos** eran `shed-N -> peloton`, y el dueño lo
 * vio en producción («¿qué me dices de este tercer grupo que va a 94 km/h?», «los que pierden en
 * montaña cinco minutos se reintegran demasiado fácil»). De 192 saltos por Giro a 11.
 *
 ...
 *   tres que llegan al mismo reloj, que es el desempate del sprint. Tenía que ser así: en una llana
 *   no hay grupos rotos que reenganchar, así que la puerta no se usa.
 * - **Las dos reinas sí**: 125 y 166 corredores cambian de tiempo, con el peor caso en 98 s y 245 s
 *   —y la cola de la segunda llega ANTES, no después—. Es donde vive el defecto: allí sí hay
 *   grupetos entrando y saliendo del pelotón todo el rato.
 ...
 *
 * También entran en este sello las otras reglas de la v58 —el equipo que no persigue a su propio
 * maillot, y el que deja de tirar cuando su hombre de la general se ha quedado a más de un grupo—,
 * y se comprobó que la limpieza del motivo de relevo al cambiar de grupo NO mueve la huella: con y
 * sin ella el resultado es idéntico, porque es una etiqueta de la foto y no física.
 */
