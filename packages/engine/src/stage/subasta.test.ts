...
/**
 * EL INTERRUPTOR DEL PASO 9, QUE NO TENÍA SELLO (añadido en la v73.1).
 *
 ...
 * encendida mientras afirmaban que estaba apagada** (docs/balance.md «v73.1»), herencia del encendido
