...
describe('engine: el interruptor del paso 6', () => {
  /**
   * EL SELLO DICE LO QUE AFIRMA (v74). Hasta aquí este caso se llamaba como si la capa estuviera
   ...
   */
  it('nace apagada: la aduana aún no decide la cuerda (v65, sello corregido en la v74)', () => {
