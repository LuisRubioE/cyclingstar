...
export function Objectives() {
  ...
  return (
    <section className="space-y-4">
      <SectionBar>Season objectives</SectionBar>
      <p className="text-sm text-slate-500">
        Star the races you want to target. Your team weighs your wishes when picking squads — but a
        wish is no guarantee, and missing a targeted race stings your morale.
      </p>
      <Panel
        title="Race calendar"
        action={<span className="text-xs font-medium text-white/90">{targets} targeted</span>}
        bodyClassName="p-2"
      >
